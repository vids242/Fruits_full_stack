                    ...
                    <nav className="navbar   navbar-expand-xl">
                        ...
                        <div className={`collapse navbar-collapse  ${themeContext.theme}`} id="navbarCollapse">
                            ...
                            <div className="d-flex m-3 me-0 align-items-center">
                                ...
                                {
                                    isAuthentication ? <LogoutIcon fontSize='large' className='me-2' onClick={handalLogout}/> : <NavLink to={'/authform'} className="my-auto">
                                        <i className="fas fa-user fa-2x" />
                                    </NavLink>
                                }
                                {
                                    themeContext.theme === 'light' ? <LightModeIcon  className='ms-1' onClick={hendalTheme} fontSize='large' /> : <NightsStayIcon className='ms-1' onClick={hendalTheme} fontSize='large' />
                                }
                            </div>
